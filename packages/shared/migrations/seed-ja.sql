-- BLOG_DB Japanese Initial Seed Data
-- 1. Languages
INSERT OR IGNORE INTO languages (code, name, is_default, sort_order, fallback_message) VALUES
('ja', '日本語', 1, 1, 'このポストは日本語で作成されました。'),
('ko', '한국어', 0, 2, '이 포스트는 한국어로 작성되었습니다.'),
('en', 'English', 0, 3, 'This post is written in English.');

-- 2. Blog Settings (Pure Japanese Default with Premium Minimal Georgia Layout & Japanese Translations)
