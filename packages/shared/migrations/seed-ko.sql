-- BLOG_DB Korean Initial Seed Data
-- 1. Languages
INSERT OR IGNORE INTO languages (code, name, is_default, sort_order, fallback_message) VALUES
('ko', '한국어', 1, 1, '이 포스트는 한국어로 작성되었습니다.'),
('en', 'English', 0, 2, 'This post is written in English.'),
('ja', '日本語', 0, 3, 'この投稿は日本語で書かれています。');

-- 2. Blog Settings (Pure Korean Default with Premium Minimal Georgia Layout & Japanese Translations)
